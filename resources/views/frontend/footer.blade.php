...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Footer Component - Adjusted</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Plus+Jakarta+Sans:wght@700&display=swap" rel="stylesheet">
    <style>
        body {
        ...
        /* Footer Styling - Exact match from health tips */
        footer {
            background: linear-gradient(180deg, #1a3c34 0%, #0f2a22 100%);
            color: #fff;
            position: relative;
...
<body>
    ...
    <div class="main-content">
        <div>
            ...
            <p>This is demo content to show how the footer looks. The footer below matches exactly the one from the health tips file.</p>
        </div>
    </div>

    <!-- Footer - Exact match from health tips file -->
    <footer>
