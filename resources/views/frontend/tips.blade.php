...
<head>
    ...
    <link rel="preload" href="images/juice1.png" as="image">
...
<body>
    <nav class="navbar">
        <div class="navbar-container">
            <a href="/" class="navbar-brand">
                <img src="images/TC_LOGO.jpg" alt="Tropical Cane Logo" class="brand-logo">
    ...
    <div class="content-container">
        ...
        <div class="product-visual">
            ...
            <img src="images/juice1.png" alt="Ginger Lemon Cane Juice" class="product-image" id="productImage">
    ...
    <script>
        ...
        const flavorData = {
            ...
            'ginger-tangerine': {
                ...
                subtitle: '420ml Fresh Daily',
                image: 'images/tangerine_and_ginger_1-removebg-preview.png',
        ...
        function orderNow() {
            ...
            setTimeout(() => {
                alert(`Thanks for your interest in our ${currentFlavor.replace('-', ' ')} drink! 🥤\n\nOrder details:\n• Flavor: ${currentFlavor.charAt(0).toUpperCase() + currentFlavor.slice(1)}\n• Size: 8.5 FL OZ\n• Price: Contact us for pricing\n\nWe'll redirect you to our order form!`);
